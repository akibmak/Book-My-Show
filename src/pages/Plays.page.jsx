        ...
        <div className="w-full lg:flex lg:flex-row-reverse">
          ...
          <div className="lg:w-3/12 ">
            ...
            <div>
              ...
              <PlaysFilter
                title="Categories"
                tags={["Theater", "Online Streaming Plays"]}
              />
              <PlaysFilter
                title="Genres"
                tags={["Axtion", "Comedy", "Drama"]}
              />
              <PlaysFilter
                title="More Filters"
                tags={["Online Streaming", "Outdoor Event", "Kids Allowed"]}
              />
              <PlaysFilter
                title="Price"
                tags={["Free", "0-500", "501-2000","Above 2000"]}
              />
              <div className="flex justify-center border-2 border-red-400 w-full py-2 rounded-lg my-2">
                  <p className="text-red-600">Brouse By Vanues</p>
              </div>
            </div>
          </div>
        </div>
